...
syms = [
 ...
 ("cons", ArrowT (SeqT (ArrowT DynT DynT)) (ArrowT DynT DynT), m cons),
 ("ifthen", ArrowT (TupT [ArrowT DynT BoolT, ArrowT DynT DynT]) (ArrowT DynT DynT), m cond),
 ...
 ("hd", ArrowT (SeqT DynT) DynT, m hd),
 ("tl", ArrowT (SeqT DynT) (SeqT DynT), m tl),
 ("hdr", ArrowT (SeqT DynT) DynT, m hdr),
 ("tlr", ArrowT (SeqT DynT) (SeqT DynT), m tlr),
 -- io
 ("out", ArrowT (SeqT (SeqT CharT)) (SeqT (SeqT CharT)), m out),
 -- misc
 -- ("id", ArrowT DynT DynT, m id),
 ("id", ForallT ["a"] (ArrowT (TvarT "a") (TvarT "a")), m id),
 ("signal", DynT, m signal),
...
env :: Env Expr
env = Env.fromList $ map (\(name, _, expr) -> (name, expr)) syms


symbols :: Map String FnSymbol
symbols = Map.fromList $ map (\(name, _, _) -> (name, name)) syms
