          ...
          srcfile = SrcFile "Core.Happstack" ["Core"] Nothing $ Right $
                    ([tagTypename],
                     Map.fromList [("a", (ArrowT DynT DynT, tagM Html.a)),
                                   ...
                                   ("Html.body", (ArrowT DynT DynT, tagM Html.body)),
                                   ...
                                   ("Html.div", (ArrowT DynT DynT, tagM Html.div)),
                                   ...
                                   ("Html.head", (ArrowT DynT DynT, tagM Html.head)),
                                   ...
                                   ("Html.link", (ArrowT DynT DynT, singleTagM Html.link)),
                                   ("Html.map", (ArrowT DynT DynT, tagM Html.map)),
                                   ...
                                   ("Html.span", (ArrowT DynT DynT, tagM Html.span)),
